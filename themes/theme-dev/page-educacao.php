...
<main id="main" class="site-main">
	...
	<section class="bg-[#F0F0F0] py-16">
		<div class="container grid grid-cols-3 gap-16 px-36">
			...
			<?php for($i = 0; $i < 6; $i++) : ?>
				<div class="our-school-item">
					...
					<h6 class="text-2xl font-bold font-red-hat-display text-center uppercase text-white">
						Valores cristãos
					</h6>
				</div>
			<?php endfor; ?>
	...
	<section class="py-32">
		...
		<div class="container flex flex-wrap justify-center px-10">
