...
<div id="primary" class="content-area">
	<main id="main" class="site-main">
		...
		<?php while (have_posts()) : the_post(); ?>
			...
			<!-- banner -->
			<?php
			$editorial_category_name = get_categories_setting()['editorials']['obras-sociais']['name'];
			...
			<!-- our school -->
			<section class="hidden bg-[#F0F0F0] pt-16 ">
			...
			<!-- blog -->
			<?php echo get_template_part('template-parts/content', 'general-blog', get_general_blog_setting($editorial_category_slug, 'obras-sociais')) ?>
			<!-- end blog -->
