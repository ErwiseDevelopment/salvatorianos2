...
<div id="primary" class="content-area">
	<main id="main" class="site-main">
		...
		<?php while (have_posts()) : the_post(); ?>
			...
			echo get_template_part('template-parts/content', 'general-news-editorial', get_general_news_editorial_setting('Saiba tudo sobre Pe. Jordan', $editorial_category_slug, 'Todas as notícias do Pe. Jordan', 'noticias?editoria=pe-jordan'))
			?>
			<!-- end posts editorial -->
