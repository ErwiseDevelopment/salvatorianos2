...
<section class="relative">
	...
	<div class="container relative grid grid-cols-2 gap-4">
		...
		<div>
			<img src="<?php echo get_template_directory_uri() ?>/resources/images/candle.png" alt="Vela Virtual - Salvatorianos" />
		</div>

		<div class="flex flex-col justify-center px-10">
			<h4 class="text-5xl font-black font-red-hat-display text-white mb-6">
				Acenda sua vela!
			</h4>
	...
	<div class="container grid grid-cols-3 gap-16">
		...
		<?php for($i = 0; $i < 9; $i++) : ?>
			<div class="flex flex-col items-center">
				<div class="w-[230px] h-[230px] rounded-full overflow-hidden flex justify-center items-center bg-gradient-b-green-200">
					<img class="" src="<?php echo get_template_directory_uri() ?>/resources/images/icon-candle.png" alt="Vela Virtual - Salvatorianos" />
				</div>

				<h5 class="text-4xl font-medium font-red-hat-display text-center text-[#4B837B] mt-4">
					Acesa por <br />
